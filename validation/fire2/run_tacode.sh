...
# This directory holds more than one configuration. Any argument is passed on to
# tacode.py, so
#   ./run_tacode.sh -file config_6dof.yml
# runs the six-degree-of-freedom one. run_segments.py drives the chain of runs
# that follows the heat-shield ejections.
